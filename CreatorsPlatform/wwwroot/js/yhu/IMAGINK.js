...
function WorkChanges(e) {
	...
	$.ajax({
		...
		success: function (response) {
			...
			$("#Woklist1img").append(
				`<a class="dropdown-item"${response[0].contentId != undefined ? `href="/Creator/GetPost/${response[0].contentId}` : ` href=""`}>			
			...
			//----------------------------
			$("#Woklist2img").append(
				`<a class="dropdown-item"   ${response[1].contentId != undefined ? `href="/Creator/GetPost/${response[1].contentId}` : ` href=""`}>
					<div class="ToMiddle image-container">
			...
			//-----------------------------
			$("#Woklist3img").append(
				`<a class="dropdown-item" ${response[2].contentId != undefined ? `href="/Creator/GetPost/${response[2].contentId}` : `href="" `}>
					<div class="ToMiddle image-container">
